...
class Denoiser:
    def __init__(self,modelpath= "./Denoiser"):
        ...
        self.model = tf.keras.models.load_model(self.modelpath, compile=False)
...
if __name__=='__main__':
    ...
    for ecgdata in datas[idx:]:
        ...
        sio.savemat(matpath+'data'+str(idx)+'.mat',{'Original Input':ecgdata,'Denoised Output':denoised_ecgdata})
        print("Finishing...")